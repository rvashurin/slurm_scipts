...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/mimo_cifar10_resnet_28_20_15.log     # Standard output and error log
...
/trinity/home/r.vashurin/codebases/mimo/run_experiments_zh_15.sh
