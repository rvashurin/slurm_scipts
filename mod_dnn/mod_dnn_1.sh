...
#SBATCH --job-name=mod_dnn                   # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/mod_dnn.log     # Standard output and error log
...
/trinity/home/r.vashurin/codebases/modulated_dnn/train_dropout_zh.sh $1 $2 0 $3
