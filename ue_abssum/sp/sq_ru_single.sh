...
#SBATCH --job-name=sq_ru_single            # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/sq_ru_single.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_sq_ru_single DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
