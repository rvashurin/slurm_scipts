...
#SBATCH --job-name=rubq_ensemble_prefix     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/rubq_ensemble_prefix.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_rubq_en_ensemble_xl DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
