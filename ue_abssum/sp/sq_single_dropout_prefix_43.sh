...
#SBATCH --job-name=sq_single_prefix_43     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/sq_single_prefix_43.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_wdsq_en_single_dropout_large_43 DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
