...
#SBATCH --job-name=rubq_single_prefix_46     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/rubq_single_prefix_46.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_rubq_en_single_dropout_xl_46 DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
