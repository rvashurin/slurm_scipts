...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/rubq_ensemble_prefix_pe_mean_probas_p_0.0.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_rubq_en_cuda_ensemble_xl_pe_p_0.0 DEVICE_FOR_DATA_RESTORING="cpu" python run_ue_t5.py
