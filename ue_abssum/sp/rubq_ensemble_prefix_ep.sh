...
#SBATCH --job-name=rubq_ensemble_prefix_ep     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/rubq_ensemble_prefix_ep_mean_probas.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_rubq_en_cuda_ensemble_xl_ep DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
