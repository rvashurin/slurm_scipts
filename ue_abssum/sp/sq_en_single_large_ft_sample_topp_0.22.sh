...
#SBATCH --job-name=sq_en_single_large_ft_sample_topp_0.22            # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/sq_en_single_large_ft_sample_topp_0.22.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_sq_en_single_large_ft_sample_topp_0.22 DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
