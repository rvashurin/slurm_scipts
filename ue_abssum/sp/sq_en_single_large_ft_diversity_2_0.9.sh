...
#SBATCH --job-name=sq_en_single_large_ft_diversity_2_0.9            # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/sq_en_single_large_ft_diversity_2_0.9.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_sq_en_single_large_ft_diversity_2_0.9 DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
