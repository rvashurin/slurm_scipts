...
#SBATCH --job-name=rubq_ru_single            # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/rubq_ru_single.log
...
cd ~/codebases/ue_abssum_single_ood_perf

HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_rubq_ru_single DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
