...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/sq_ensemble_prefix_pe_mean_probas_ft_p_0.04.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=sp_wdsq_en_cuda_ensemble_large_ft_pe_p_0.04 DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
