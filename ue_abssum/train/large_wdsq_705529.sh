...
#SBATCH --job-name=train_wdsq_large_705529          # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/train_wdsq_large_705529.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=train_t5_large_wdsq_705529 python train_t5.py
