...
#SBATCH --job-name=train_rubq_large_23422       # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/train_rubq_large_23422.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=train_t5_large_rubq_23422 python train_t5_peft.py
