...
#SBATCH --job-name=train_rubq_large_12349       # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/train_rubq_large_12349.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=train_t5_large_rubq_12349 python train_t5_peft.py
