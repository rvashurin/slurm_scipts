...
#SBATCH --job-name=train_wdsq_large_12345          # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/train_wdsq_large_12345.log
...
HYDRA_CONFIG_PATH=configs/t5/sp/with_prefix_tree HYDRA_CONFIG_NAME=train_t5_large_wdsq_12345 python train_t5.py
