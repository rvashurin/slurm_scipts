...
#SBATCH --job-name=sq_sq_ensemble     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/sq_sq_ensemble.log
...
MAX_TRAIN_DATA_SIZE=1000 HYDRA_CONFIG_NAME=ood_sq_sq_ensemble DEVICE_FOR_DATA_RESTORING="cpu" python run_ue_t5.py
