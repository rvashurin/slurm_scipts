...
#SBATCH --job-name=sq_en_ru_single     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/sq_en_ru_single.log
...
HYDRA_CONFIG_PATH=configs/t5/ood HYDRA_CONFIG_NAME=ood_sq_en_ru_single DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
