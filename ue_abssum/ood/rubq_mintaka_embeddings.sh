...
#SBATCH --job-name=rubq_mintaka_embeddings     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/rubq_mintaka_embeddings.log
...
HYDRA_CONFIG_NAME=ood_rubq_mintaka_embeddings DEVICE_FOR_DATA_RESTORING="cpu" python run_ue_t5.py
