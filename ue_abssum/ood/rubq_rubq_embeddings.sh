...
#SBATCH --job-name=rubq_rubq_embeddings     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/rubq_rubq_embeddings.log
...
HYDRA_CONFIG_NAME=ood_rubq_rubq_embeddings DEVICE_FOR_DATA_RESTORING="cpu" python run_ue_t5.py
