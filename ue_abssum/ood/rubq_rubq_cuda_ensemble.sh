...
#SBATCH --job-name=rubq_rubq_cuda_ensemble     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ue_abssum_logs/rubq_rubq_cuda_ensemble.log
...
HYDRA_CONFIG_NAME=ood_rubq_rubq_cuda_ensemble DEVICE_FOR_DATA_RESTORING="cuda:0" python run_ue_t5.py
