...
#SBATCH --job-name=gemma_2_instruct_wmt14_deen_test_train
...
#SBATCH --output=/l/users/maxim.panov/log/detr_ue_nmt/gemma_2_instruct_wmt14_deen_test_train
