...
#SBATCH --job-name=euro9b_instruct_wmt14_deen_test_train_zeroshot
...
#SBATCH --output=/l/users/maxim.panov/log/detr_ue_nmt/euro9b_instruct_wmt14_deen_test_train_zeroshot
