...
#SBATCH --job-name=falcon_3_1b_wmt14_csruen_test_train_multigpu
...
#SBATCH --output=/l/users/maxim.panov/log/detr_ue_nmt/falcon_3_1b_wmt14_csruen_test_train_multigpu
