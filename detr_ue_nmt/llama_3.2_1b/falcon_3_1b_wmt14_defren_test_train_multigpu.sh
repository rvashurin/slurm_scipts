...
#SBATCH --job-name=falcon_3_1b_wmt14_defren_test_train_multigpu
...
#SBATCH --output=/l/users/maxim.panov/log/detr_ue_nmt/falcon_3_1b_wmt14_defren_test_train_multigpu
...
TOKENIZERS_PARALLELISM=true OPENBLAS_MAIN_FREE=1 HF_HOME=/l/users/maxim.panov/cache HYDRA_CONFIG=`pwd`/examples/configs/polygraph_eval_wmt14_deen.yaml polygraph_eval batch_size=1 cache_path=/l/users/maxim.panov/cache model=llama_1b model.path=tiiuae/Falcon3-1B-Base subsample_eval_dataset=2000 deberta_batch_size=1 +deberta_device=cuda:0 model.load_model_args.device_map=cuda:0 > /l/users/maxim.panov/log/detr_ue_nmt/falcon_3_1b_wmt14_defren_test_train_multigpu_deen.log 2>&1 &

TOKENIZERS_PARALLELISM=true OPENBLAS_MAIN_FREE=1 HF_HOME=/l/users/maxim.panov/cache HYDRA_CONFIG=`pwd`/examples/configs/polygraph_eval_wmt14_deen.yaml polygraph_eval batch_size=1 cache_path=/l/users/maxim.panov/cache model=llama_1b model.path=tiiuae/Falcon3-1B-Base subsample_eval_dataset=2000 deberta_batch_size=1 +deberta_device=cuda:1 model.load_model_args.device_map=cuda:1 eval_split=train > /l/users/maxim.panov/log/detr_ue_nmt/falcon_3_1b_wmt14_defren_test_train_multigpu_deen_train.log 2>&1 &

TOKENIZERS_PARALLELISM=true OPENBLAS_MAIN_FREE=1 HF_HOME=/l/users/maxim.panov/cache HYDRA_CONFIG=`pwd`/examples/configs/polygraph_eval_wmt14_fren.yaml polygraph_eval batch_size=1 cache_path=/l/users/maxim.panov/cache model=llama_1b model.path=tiiuae/Falcon3-1B-Base subsample_eval_dataset=2000 deberta_batch_size=1 +deberta_device=cuda:2 model.load_model_args.device_map=cuda:2 > /l/users/maxim.panov/log/detr_ue_nmt/falcon_3_1b_wmt14_defren_test_train_multigpu_fren.log 2>&1 &

TOKENIZERS_PARALLELISM=true OPENBLAS_MAIN_FREE=1 HF_HOME=/l/users/maxim.panov/cache HYDRA_CONFIG=`pwd`/examples/configs/polygraph_eval_wmt14_fren.yaml polygraph_eval batch_size=1 cache_path=/l/users/maxim.panov/cache model=llama_1b model.path=tiiuae/Falcon3-1B-Base subsample_eval_dataset=2000 deberta_batch_size=1 +deberta_device=cuda:3 model.load_model_args.device_map=cuda:3 eval_split=train > /l/users/maxim.panov/log/detr_ue_nmt/falcon_3_1b_wmt14_defren_test_train_multigpu_fren_train.log 2>&1 &
