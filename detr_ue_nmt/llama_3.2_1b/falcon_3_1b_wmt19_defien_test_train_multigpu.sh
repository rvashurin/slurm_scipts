...
#SBATCH --job-name=falcon_3_1b_wmt19_defien_test_train_multigpu
...
#SBATCH --output=/l/users/maxim.panov/log/detr_ue_nmt/falcon_3_1b_wmt19_defien_test_train_multigpu
