...
#SBATCH --job-name=qwen_2.5_1.5b_wmt14_defren_test_train_multigpu
...
#SBATCH --output=/l/users/maxim.panov/log/detr_ue_nmt/qwen_2.5_1.5b_wmt14_defren_test_train_multigpu
