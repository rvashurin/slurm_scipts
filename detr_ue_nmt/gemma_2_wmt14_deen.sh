...
#SBATCH --output=/l/users/maxim.panov/log/detr_ue_nmt/gemma_2_wmt14_deen
...
HF_HOME=/l/users/maxim.panov/cache HYDRA_CONFIG=`pwd`/examples/configs/polygraph_eval_wmt14_deen.yaml polygraph_eval batch_size=1 cache_path=/l/users/maxim.panov/cache model=gemma subsample_eval_dataset=2000 deberta_batch_size=1
