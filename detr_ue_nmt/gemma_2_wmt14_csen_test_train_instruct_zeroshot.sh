...
#SBATCH --job-name=gemma_2_instruct_wmt14_csen_test_train_zeroshot
...
#SBATCH --output=/l/users/maxim.panov/log/detr_ue_nmt/gemma_2_instruct_wmt14_csen_test_train_zeroshot
