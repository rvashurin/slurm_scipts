...
#SBATCH --job-name=llama_wmt19_deen_cocoa_supervised
...
#SBATCH --output=/l/users/maxim.panov/storage_vashurin/log/llama_wmt19_deen_cocoa_supervised.log
...
PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python HF_HOME=/l/users/maxim.panov/cache HYDRA_CONFIG=`pwd`/examples/configs/polygraph_eval_wmt19_deen_cocoa_supervised.yaml polygraph_eval batch_size=1 cache_path=/l/users/maxim.panov/storage_vashurin/polygraph_out subsample_eval_dataset=2000 deberta_batch_size=1 model=llama
