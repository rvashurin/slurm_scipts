...
#SBATCH --job-name=mgenre_eop_10_rubq     # Job name
...
#SBATCH --time=01-10:00:00                   # time limit hrs:min:sec or dd-hrs:min:sec

#SBATCH --output=/gpfs/gpfs0/r.vashurin/mgenre_logs/eop_10_rubq.log
...
python mgenre_eop_generate.py spacy rubq 10
