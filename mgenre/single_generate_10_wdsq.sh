...
#SBATCH --job-name=mgenre_single_10_wdsq     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/mgenre_logs/single_10_wdsq.log
...
python mgenre_single_generate.py spacy wdsq 10
