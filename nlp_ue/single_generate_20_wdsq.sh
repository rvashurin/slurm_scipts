...
#SBATCH --job-name=mgenre_single_20_wdsq     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/mgenre_logs/single_20_wdsq.log
...
python mgenre_single_generate.py spacy wdsq 20
