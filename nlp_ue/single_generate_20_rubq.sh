...
#SBATCH --job-name=mgenre_single_20_rubq     # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/mgenre_logs/single_20_rubq.log
...
python mgenre_single_generate.py spacy rubq 20
