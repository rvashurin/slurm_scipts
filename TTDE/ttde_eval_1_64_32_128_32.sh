...
#SBATCH --job-name=ttde_eval_1_64_32_128_32                  # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ttde/eval_logs/eval_1_64_32_128_32.log
