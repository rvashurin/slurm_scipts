...
#SBATCH --job-name=ttde_eval_2_128_32_128_32                  # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ttde/eval_logs/eval_2_128_32_128_32.log
