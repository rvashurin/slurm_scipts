...
#SBATCH --job-name=ttde_eval_1_256_16_64_64                  # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ttde/eval_logs/eval_1_256_16_64_64.log
