...
#SBATCH --job-name=ttde_eval_1_512_16_32_32                  # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ttde/eval_logs/eval_1_512_16_32_32.log
