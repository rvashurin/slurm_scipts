...
#SBATCH --job-name=ttde_eval_1_128_16_128_64                  # Job name
...
#SBATCH --output=/gpfs/gpfs0/r.vashurin/ttde/eval_logs/eval_1_128_16_128_64.log
